...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("font-serif text-lg font-bold leading-tight text-parchment tracking-tight", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center p-5 sm:p-6 pt-0 border-t border-slate-line/40 mt-4", className)}
    {...props}
  />
))
